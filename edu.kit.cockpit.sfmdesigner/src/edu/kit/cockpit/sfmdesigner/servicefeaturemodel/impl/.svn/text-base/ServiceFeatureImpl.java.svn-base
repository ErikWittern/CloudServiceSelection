 ...
 *   <li>{@link edu.kit.cockpit.sfmdesigner.servicefeaturemodel.impl.ServiceFeatureImpl#getContainsVariant <em>Contains Variant</em>}</li>
 ...
 *   <li>{@link edu.kit.cockpit.sfmdesigner.servicefeaturemodel.impl.ServiceFeatureImpl#getDecomposesInto <em>Decomposes Into</em>}</li>
 ...
 *   <li>{@link edu.kit.cockpit.sfmdesigner.servicefeaturemodel.impl.ServiceFeatureImpl#getFeatureType <em>Feature Type</em>}</li>
...
public abstract class ServiceFeatureImpl extends EObjectImpl implements ServiceFeature {
	...
	/**
	 * The cached value of the '{@link #getDecomposesInto() <em>Decomposes Into</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getDecomposesInto()
	 * @generated
	 * @ordered
	 */
	protected EList<ServiceFeature> decomposesInto;
	 ...
	 * @ordered
	 */
	protected static final FeatureTypes FEATURE_TYPE_EDEFAULT = FeatureTypes.GROUPING_FEATURE;
	...
	public NotificationChain basicSetContainsVariant(Variant newContainsVariant, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ServicefeaturemodelPackage.SERVICE_FEATURE__CONTAINS_VARIANT, oldContainsVariant, newContainsVariant);
	...
	public void setContainsVariant(Variant newContainsVariant) {
		if (newContainsVariant != containsVariant) {
			...
			if (containsVariant != null)
				msgs = ((InternalEObject)containsVariant).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ServicefeaturemodelPackage.SERVICE_FEATURE__CONTAINS_VARIANT, null, msgs);
			if (newContainsVariant != null)
				msgs = ((InternalEObject)newContainsVariant).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ServicefeaturemodelPackage.SERVICE_FEATURE__CONTAINS_VARIANT, null, msgs);
			msgs = basicSetContainsVariant(newContainsVariant, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicefeaturemodelPackage.SERVICE_FEATURE__CONTAINS_VARIANT, newContainsVariant, newContainsVariant));
	}
	 ...
	 * @generated
	 */
	public List<ServiceFeature> getDecomposesInto() {
		if (decomposesInto == null) {
			decomposesInto = new EObjectContainmentEList<ServiceFeature>(ServiceFeature.class, this, ServicefeaturemodelPackage.SERVICE_FEATURE__DECOMPOSES_INTO);
		}
	 ...
	 * @generated
	 */
	public void setFeatureType(FeatureTypes newFeatureType) {
		FeatureTypes oldFeatureType = featureType;
		featureType = newFeatureType == null ? FEATURE_TYPE_EDEFAULT : newFeatureType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicefeaturemodelPackage.SERVICE_FEATURE__FEATURE_TYPE, oldFeatureType, featureType));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case ServicefeaturemodelPackage.SERVICE_FEATURE__DECOMPOSES_INTO:
				return ((InternalEList<?>)getDecomposesInto()).basicRemove(otherEnd, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case ServicefeaturemodelPackage.SERVICE_FEATURE__CONTAINS_EXCLUDES:
				...
				return;
			case ServicefeaturemodelPackage.SERVICE_FEATURE__DECOMPOSES_INTO:
				getDecomposesInto().clear();
				getDecomposesInto().addAll((Collection<? extends ServiceFeature>)newValue);
				return;
			case ServicefeaturemodelPackage.SERVICE_FEATURE__MIN_AMOUNT:
			...
			case ServicefeaturemodelPackage.SERVICE_FEATURE__ID:
				...
				return;
			case ServicefeaturemodelPackage.SERVICE_FEATURE__FEATURE_TYPE:
				setFeatureType((FeatureTypes)newValue);
				return;
			case ServicefeaturemodelPackage.SERVICE_FEATURE__REQUIRED:
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case ServicefeaturemodelPackage.SERVICE_FEATURE__DECOMPOSES_INTO:
				return decomposesInto != null && !decomposesInto.isEmpty();
			case ServicefeaturemodelPackage.SERVICE_FEATURE__MIN_AMOUNT:
