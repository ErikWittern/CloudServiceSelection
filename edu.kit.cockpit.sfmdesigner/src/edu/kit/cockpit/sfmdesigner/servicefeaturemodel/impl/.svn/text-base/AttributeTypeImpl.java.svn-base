...
public class AttributeTypeImpl extends EObjectImpl implements AttributeType {
	...
	/**
	 * <!-- begin-user-doc -->
	 * 	2011-09-15 Set 'domain' depending on 'aggregation rule'. Allows to hide domain field in SFM designer.
	 *  2011-09-22 Set 'scale order' depending on 'aggregation rule', if aggregation rule is 'at least once'.
	 *  2011-10-27 Set 'customAttributeTypePriority' to '3' is 'aggregation rule' is 'At Least Once'.
	 * <!-- end-user-doc -->
	 * @generated NOT
	 */
