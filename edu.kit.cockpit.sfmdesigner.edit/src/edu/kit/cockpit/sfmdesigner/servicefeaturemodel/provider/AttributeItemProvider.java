...
public class AttributeItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addOfAttributeTypePropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Of Attribute Type feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addOfAttributeTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Attribute_ofAttributeType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Attribute_ofAttributeType_feature", "_UI_Attribute_type"),
				 ServicefeaturemodelPackage.Literals.ATTRIBUTE__OF_ATTRIBUTE_TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ServicefeaturemodelPackage.Literals.ATTRIBUTE__CONTAINS_MODIFY_RELATIONSHIP);
		}
	...
	public String getText(Object object) {
		...
		if (!(((Attribute)object).getOfAttributeType() == null || ((Attribute)object).getOfAttributeType().getName().length() == 0) && (value == null || value.length() == 0)){
			return ((Attribute)object).getOfAttributeType().getName() + " : <no value> (" + getString("_UI_Attribute_type") + ")";
		} else if ((((Attribute)object).getOfAttributeType() == null || ((Attribute)object).getOfAttributeType().getName().length() == 0) && !(value == null || value.length() == 0)){
			return  "<no type selected> : " + value + " (" + getString("_UI_Attribute_type") + ")";
		} else if (!(((Attribute)object).getOfAttributeType() == null || ((Attribute)object).getOfAttributeType().getName().length() == 0) && !(value == null || value.length() == 0)){
			return ((Attribute)object).getOfAttributeType().getName() + " : " + value + " (" + getString("_UI_Attribute_type") + ")";
		}
		return returnString;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Attribute.class)) {
			...
			case ServicefeaturemodelPackage.ATTRIBUTE__OF_ATTRIBUTE_TYPE:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ServicefeaturemodelPackage.Literals.ATTRIBUTE__CONTAINS_MODIFY_RELATIONSHIP,
				 ServicefeaturemodelFactory.eINSTANCE.createAttributeToAttributeModifyRelationship()));

		newChildDescriptors.add
			(createChildParameter
				(ServicefeaturemodelPackage.Literals.ATTRIBUTE__CONTAINS_MODIFY_RELATIONSHIP,
				 ServicefeaturemodelFactory.eINSTANCE.createFeatureToAttributeModifyRelationship()));
	}
