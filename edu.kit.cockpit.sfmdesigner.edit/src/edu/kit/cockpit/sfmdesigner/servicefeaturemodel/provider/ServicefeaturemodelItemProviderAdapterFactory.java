...
public class ServicefeaturemodelItemProviderAdapterFactory extends ServicefeaturemodelAdapterFactory implements ComposeableAdapterFactory, IChangeNotifier, IDisposable {
	...
	/**
	 * This keeps track of the one adapter used for all {@link edu.kit.cockpit.sfmdesigner.servicefeaturemodel.PossibleConfigurations} instances.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected PossibleConfigurationsItemProvider possibleConfigurationsItemProvider;

	/**
	 * This creates an adapter for a {@link edu.kit.cockpit.sfmdesigner.servicefeaturemodel.PossibleConfigurations}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Adapter createPossibleConfigurationsAdapter() {
		if (possibleConfigurationsItemProvider == null) {
			possibleConfigurationsItemProvider = new PossibleConfigurationsItemProvider(this);
		}

		return possibleConfigurationsItemProvider;
	}
	...
	/**
	 * This keeps track of the one adapter used for all {@link edu.kit.cockpit.sfmdesigner.servicefeaturemodel.AttributeToAttributeModifyRelationship} instances.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected AttributeToAttributeModifyRelationshipItemProvider attributeToAttributeModifyRelationshipItemProvider;

	/**
	 * This creates an adapter for a {@link edu.kit.cockpit.sfmdesigner.servicefeaturemodel.AttributeToAttributeModifyRelationship}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Adapter createAttributeToAttributeModifyRelationshipAdapter() {
		if (attributeToAttributeModifyRelationshipItemProvider == null) {
			attributeToAttributeModifyRelationshipItemProvider = new AttributeToAttributeModifyRelationshipItemProvider(this);
		}

		return attributeToAttributeModifyRelationshipItemProvider;
	}

	/**
	 * This keeps track of the one adapter used for all {@link edu.kit.cockpit.sfmdesigner.servicefeaturemodel.FeatureToAttributeModifyRelationship} instances.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected FeatureToAttributeModifyRelationshipItemProvider featureToAttributeModifyRelationshipItemProvider;

	/**
	 * This creates an adapter for a {@link edu.kit.cockpit.sfmdesigner.servicefeaturemodel.FeatureToAttributeModifyRelationship}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Adapter createFeatureToAttributeModifyRelationshipAdapter() {
		if (featureToAttributeModifyRelationshipItemProvider == null) {
			featureToAttributeModifyRelationshipItemProvider = new FeatureToAttributeModifyRelationshipItemProvider(this);
		}

		return featureToAttributeModifyRelationshipItemProvider;
	}
	...
	public void dispose() {
		...
		if (possibleConfigurationsItemProvider != null) possibleConfigurationsItemProvider.dispose();
		...
		if (attributeToAttributeModifyRelationshipItemProvider != null) attributeToAttributeModifyRelationshipItemProvider.dispose();
		if (featureToAttributeModifyRelationshipItemProvider != null) featureToAttributeModifyRelationshipItemProvider.dispose();
	}
