...
public class ConfigurationItemProvider
	...
	protected void addGroupsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Configuration_groups_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Configuration_groups_feature", "_UI_Configuration_type"),
				 ServicefeaturemodelPackage.Literals.CONFIGURATION__GROUPS,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ServicefeaturemodelPackage.Literals.CONFIGURATION__EVALUATED_BY);
			childrenFeatures.add(ServicefeaturemodelPackage.Literals.CONFIGURATION__DESCRIBED_BY);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ServicefeaturemodelPackage.Literals.CONFIGURATION__EVALUATED_BY,
				 ServicefeaturemodelFactory.eINSTANCE.createPreference()));

		newChildDescriptors.add
			(createChildParameter
				(ServicefeaturemodelPackage.Literals.CONFIGURATION__DESCRIBED_BY,
