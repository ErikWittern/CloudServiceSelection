...
public class ServiceItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ServicefeaturemodelPackage.Literals.SERVICE__REPRESENTED_BY);
			childrenFeatures.add(ServicefeaturemodelPackage.Literals.SERVICE__ENABLES);
			childrenFeatures.add(ServicefeaturemodelPackage.Literals.SERVICE__HAS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ServicefeaturemodelPackage.Literals.SERVICE__REPRESENTED_BY,
				 ServicefeaturemodelFactory.eINSTANCE.createServiceFeatureDiagram()));

		newChildDescriptors.add
			(createChildParameter
				(ServicefeaturemodelPackage.Literals.SERVICE__ENABLES,
				 ServicefeaturemodelFactory.eINSTANCE.createPossibleConfigurations()));

		newChildDescriptors.add
			(createChildParameter
				(ServicefeaturemodelPackage.Literals.SERVICE__HAS,
