...
public class ServiceFeatureItemProvider
	 ...
	 *  2011-09-14 MapsToGSMElement & AssociatedGSMElement further disabled, because all mapping is done by the "create alternative features" method.
	 * <!-- end-user-doc -->
	 * @generated NOT
	 */
	@Override
	 ...
	 * <!-- begin-user-doc -->
	 * 	2011-09-09 Creation of Service Features and OR/XOR gates made impossible under "Service requests" service feature.
	 * <!-- end-user-doc -->
	 * @generated NOT
	 */
	@Override
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		// Add further functions only if parent node is not the processes node:
		if(object instanceof ServiceFeature){

			ServiceFeature sf = (ServiceFeature)object;
			boolean sfIsProcessesFeature = false;
			if(sf.getName() != null && sf.getName().equals("Service requests")){
				sfIsProcessesFeature = true;
			}
			
			boolean hasContainer = true;
			boolean withinProcesses = false;
			EObject containerObject = sf.eContainer(); // Must be != null, because a Service Feature is always in the Service Feature Diagram
			while(hasContainer){
				if(containerObject instanceof ServiceFeature 
						&& ((ServiceFeature) containerObject).getName() != null
						&& ((ServiceFeature) containerObject).getName().equals("Service requests"))
				{
					withinProcesses = true;
					break;
				}
				if(containerObject.eContainer() != null){
			...
			if(!sfIsProcessesFeature && !withinProcesses){
				newChildDescriptors.add
					(createChildParameter
