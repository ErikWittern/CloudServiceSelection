...
public interface ServicefeaturemodelFactory extends EFactory {
	...
	/**
	 * Returns a new object of class '<em>Possible Configurations</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return a new object of class '<em>Possible Configurations</em>'.
	 * @generated
	 */
	PossibleConfigurations createPossibleConfigurations();
	...
	/**
	 * Returns a new object of class '<em>Attribute To Attribute Modify Relationship</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return a new object of class '<em>Attribute To Attribute Modify Relationship</em>'.
	 * @generated
	 */
	AttributeToAttributeModifyRelationship createAttributeToAttributeModifyRelationship();

	/**
	 * Returns a new object of class '<em>Feature To Attribute Modify Relationship</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return a new object of class '<em>Feature To Attribute Modify Relationship</em>'.
	 * @generated
	 */
	FeatureToAttributeModifyRelationship createFeatureToAttributeModifyRelationship();
