...
public class ServicefeaturemodelFactoryImpl extends EFactoryImpl implements ServicefeaturemodelFactory {
	...
	public static ServicefeaturemodelFactory init() {
		try {
			ServicefeaturemodelFactory theServicefeaturemodelFactory = (ServicefeaturemodelFactory)EPackage.Registry.INSTANCE.getEFactory("http://servicefeaturemodel/1.0"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case ServicefeaturemodelPackage.POSSIBLE_CONFIGURATIONS: return createPossibleConfigurations();
			...
			case ServicefeaturemodelPackage.ATTRIBUTE_TO_ATTRIBUTE_MODIFY_RELATIONSHIP: return createAttributeToAttributeModifyRelationship();
			case ServicefeaturemodelPackage.FEATURE_TO_ATTRIBUTE_MODIFY_RELATIONSHIP: return createFeatureToAttributeModifyRelationship();
			default:
	 ...
	 * @generated
	 */
	public PossibleConfigurations createPossibleConfigurations() {
		PossibleConfigurationsImpl possibleConfigurations = new PossibleConfigurationsImpl();
